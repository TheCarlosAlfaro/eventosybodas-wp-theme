	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'eventosybodas' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'eventosybodas' ); ?></th>
			</tr>
		</thead>
		<tbody>
