...
add_action('rest_api_init', 'eventosybodasRegisterSearch');

function eventosybodasRegisterSearch() {
  register_rest_route('eventosybodas/v1', 'search', array(
    'methods' => WP_REST_SERVER::READABLE,
    'callback' => 'eventosybodasSearchResults'
  ));
}

function eventosybodasSearchResults($data) {
